...
*(Add screenshots here after running the app — e.g. Home page, Match Score
gauge, Skill Comparison, Personalized Feedback, Chatbot.)*

- `screenshots/home.png`
- `screenshots/match_score.png`
- `screenshots/skill_comparison.png`
